...
(
	...
	"ДенежныйЯщик" NVARCHAR2(14) NULL,

	"КоличествоДенег" FLOAT(126) NULL,
...
ALTER TABLE "ПроверкаДенег"
	ADD CONSTRAINT "ПроверкаДене_9393" FOREIGN KEY ("Сотрудники") REFERENCES "Сотрудники" ("primaryKey");

CREATE INDEX "ПроверкаДене_9225" on "ПроверкаДенег" ("Сотрудники");
...
ALTER TABLE "Напитки"
	ADD CONSTRAINT "Напитки_FСост_2289" FOREIGN KEY ("Составы") REFERENCES "Составы" ("primaryKey");

CREATE INDEX "Напитки_IСоставы" on "Напитки" ("Составы");
